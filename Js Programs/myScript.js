...
// Function which gives pokemon information
function pokemonInfo(pname)
{
  console.log("Below is the info for pokemon:")
  for(i=0; i<pokemonData.pokemon.length; i++)
  {
    if(pokemonData.pokemon[i].name == pname)
    {
      var pinfo = pokemonData.pokemon[i];
      console.log(pinfo);
    }
  }
}
...
var flag = 0; //required to tell about whether name of pokemon is there or not in next_evaluation field
// Function which gives info about pokemon's name in next_evolution field
function pokemon_next_evolution(pname)
{
  console.log("Below is list for next_evolution:")
  for(i=0; i<pokemonData.pokemon.length; i++)
  {
    if(pokemonData.pokemon[i].next_evolution)
    {
      for(j=0; j<pokemonData.pokemon[i].next_evolution.length; j++)
      {
        if(pokemonData.pokemon[i].next_evolution[j].name == pname)
        {
          flag = 1;
  ...
  if(flag == 0)
  {
    console.log("Given name is not found in next_evolution field")
  }
}

pokemon_next_evolution("Poliwrath")

//Function which gives list of pokemons for given weakness
function pokemonWeaknessList(weakness)
{
  console.log("Below is the list of pokemons who have the given weakness:")
  for(i=0; i<pokemonData.pokemon.length; i++)
  {
    for(j=0; j<pokemonData.pokemon[i].weaknesses.length; j++)
    {
